...
int main(int argc, char** argv) {
    ...
    //Calculate Output
    total = (CNV_QTR * (numQrtr - 48)) + (CNV_DIM * (numDime - 48)) + (CNV_NCL * (numNckl - 48)); //Calculate the total by multiplying the number of each type of coin by its value in cents
